...
namespace SinoSunIDE
{
    partial class FrmPC : DockContent
    {
        ...
        private void MC20P801_OptionFill()
        {
            ...
            string[] OSCM = new string[] { CurLang.OSCMMC20P801String1, CurLang.OSCMMC20P801String2, CurLang.OSCMMC20P801String3, CurLang.OSCMMC20P801String4 };
            ...
            //string[] RES = new string[] { "P12上拉电阻无效", "P12上拉电阻有效" };//0,1
            string[] PROTECT = new string[] { CurLang.PROTECTMC20P24BString1, CurLang.PROTECTMC20P24BString2 }; //1,0


            propertyGridEx_PC.Item.Add("OSCM", CurLang.OSCMMC20P801String1, false, CurLang.OSCMFunc, CurLang.OSCMMC20P24BFuncExplain, true);
            ...
            //propertyGridEx_PC.Item.Add("RES", "P12上拉电阻无效", false, "P12上拉电阻设置", "RES=False P12上拉电阻无效；\nLVRE=True P12上拉电阻有效", true);
        ...
        private void MC20P801_Option2Value()
        {
            int optValue_Temp = 0;
            string temp = propertyGridEx_PC.Item[0].Value.ToString();
            frmMAIN.FREQ = 0x08;
                //"11:8MHz 内部RC振荡器", "10:4MHz 内部RC振荡器", "01:2MHz 内部RC振荡器", "00:1MHz 内部RC振荡器"
            if (temp == CurLang.OSCMMC20P801String4)
            {
                optValue_Temp = optValue_Temp | (0 << 0);
                frmMAIN.FREQ = 0x01;
            }
            else if (temp == CurLang.OSCMMC20P801String3)
            {
                optValue_Temp = optValue_Temp | (1 << 0);
                frmMAIN.FREQ = 0x02;
            }
            else if (temp == CurLang.OSCMMC20P801String2)
            {
        ...
        private void MC20P801_Value2Option(uint pValue)
        {
            uint temp = 0;
            ...
            {
                case 0:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P801String4;
                    frmMAIN.FREQ = 0x01;
                    break;
                case 1:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P801String3;
                    frmMAIN.FREQ = 0x02;
                    break;
                case 2:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P801String2;
                    frmMAIN.FREQ = 0x04;
                    break;
                default:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P801String1;
                    frmMAIN.FREQ = 0x08;
                    break;
            }
            //WDT
            ...
            //if (temp == 1)
            //{
            //    propertyGridEx_PC.Item[4].Value = "P12上拉电阻有效";
            //}
            //else
            //{
            //    propertyGridEx_PC.Item[4].Value = "P12上拉电阻无效";
            //}
