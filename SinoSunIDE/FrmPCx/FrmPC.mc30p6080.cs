...
namespace SinoSunIDE
{
    ...
    {
        private void MC30P6080_OptionFill()
        {
            ...
            propertyGridEx_PC.Item.Add("OSCM", CurLang.OSCMMC30P6080String010, false, CurLang.OSCMMC30P6060Func, CurLang.OSCMMC30P6060FuncExplain, true);
            ...
            propertyGridEx_PC.Item.Add("FINTOSC", "001:Fsys=FAS/2", false, CurLang.FINTOSCMC30P6060Func, CurLang.FINTOSCMC30P6060FuncExplain, true);
        ...
        private void MC30P6080_Option2Value()
        {
        ...
        private void MC30P6080_Value2Option(uint pValue, uint pValue0, uint pValue1, uint pValue2, uint pValue3, uint pValue4, uint pValue5)
        {
            uint temp = 0;
            int i = 0;
            //MODE
            ...
            switch (temp)
            {
                ...
                case 4:
                    ...
                    break;
                case 3:
                    //propertyGridEx_PC.Item[i].Value = "011:PWRT=640us;TWDT=18ms";
                    propertyGridEx_PC.Item[i].Value = "011:PWRT=140us;TWDT=18ms";
                    break;
                case 2:
                    //propertyGridEx_PC.Item[i].Value = "010:PWRT=640us;TWDT=4.5ms";
                    propertyGridEx_PC.Item[i].Value = "010:PWRT=140us;TWDT=4.5ms";
                    break;
                case 1:
                    //propertyGridEx_PC.Item[i].Value = "001:PWRT=640us;TWDT=288ms";
                    propertyGridEx_PC.Item[i].Value = "001:PWRT=140us;TWDT=288ms";
                    break;
                default:
                    //propertyGridEx_PC.Item[i].Value = "000:PWRT=640us;TWDT=72m";
