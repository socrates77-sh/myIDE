...
namespace SinoSunIDE
{
    partial class FrmPC : DockContent
    {
        ...
        private void MC20P04_OptionFill()
        {
            ...
            string[] OSCM = new string[] { CurLang.OSCMMC20P04String1, CurLang.OSCMMC20P04String2, CurLang.OSCMMC20P04String3, CurLang.OSCMMC20P04String4 };
            string[] WDTE = new string[] { CurLang.WDTEMC20P24BString2, CurLang.WDTEMC20P24BString1 }; //0,1
            string[] RSTE = new string[] { CurLang.RSTEMC20P04String1, CurLang.RSTEMC20P04String2 }; //0,1
            ...
            string[] RES = new string[] { CurLang.RESMC20P04String1, CurLang.RESMC20P04String2 };//0,1
            ...
            propertyGridEx_PC.Item.Add("WDTE", CurLang.WDTEMC20P24BString1, false, CurLang.WDTEMC20P01Func, CurLang.WDTEMC20P04FuncExplain1+"\n"+CurLang.WDTEMC20P04FuncExplain2, true);
            propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(WDTE, true);

            propertyGridEx_PC.Item.Add("RSTE", CurLang.RSTEMC20P04String1, false, CurLang.RSTEMC20P24BFunc, CurLang.RSTEMC20P04FuncExplain1+"\n"+CurLang.RSTEMC20P04FuncExplain2, true);
            ...
            propertyGridEx_PC.Item.Add("RES", CurLang.RESMC20P04String1, false, CurLang.RESMC20P04Func, CurLang.RESMC20P04FuncExplain1+"\n"+CurLang.RESMC20P04FuncExplain2, true);
        ...
        private void MC20P04_Option2Value()
        {
            int optValue_Temp = 0;
            string temp = propertyGridEx_PC.Item[0].Value.ToString();
            frmMAIN.FREQ = 0x08;
            //"11:8MHz 内部RC振荡器", "10:4MHz 内部RC振荡器", "01:外接400K-8MHZ晶振", "00:2MHz 内部RC振荡器"
            if (temp == CurLang.OSCMMC20P04String4)
            {
                optValue_Temp = optValue_Temp | (0 << 0);
                frmMAIN.FREQ = 0x01;
            }
            else if (temp == CurLang.OSCMMC20P04String3)
            {
                optValue_Temp = optValue_Temp | (1 << 0);
                frmMAIN.FREQ = 0x08;
                MessageBox.Show(CurLang.MessageBoxText23);
            }
            else if (temp == CurLang.OSCMMC20P04String2)
            {
            ...
            if (temp == CurLang.RSTEMC20P04String1)
            {
            ...
            if (temp == CurLang.RESMC20P04String1)
            {
        ...
        private void MC20P04_Value2Option(uint pValue)
        {
            uint temp = 0;
            ...
            {
                case 0:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P04String4;
                    frmMAIN.FREQ = 0x02;
                    break;
                case 1:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P04String3;
                    frmMAIN.FREQ = 0x08;
                    break;
                case 2:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P04String2;
                    frmMAIN.FREQ = 0x04;
                    break;
                default:
                    propertyGridEx_PC.Item[0].Value = CurLang.OSCMMC20P04String1;
                    frmMAIN.FREQ = 0x08;
                    break;
            }
            //WDT
            ...
            if (temp == 1)
            {
                propertyGridEx_PC.Item[2].Value = CurLang.RSTEMC20P04String2;
            }
            else
            {
                propertyGridEx_PC.Item[2].Value = CurLang.RSTEMC20P04String1;
            }
            //LVRS
            temp = (pValue >> 4) & 1;
            if (temp == 1)
            ...
            if (temp == 1)
            {
                propertyGridEx_PC.Item[5].Value = CurLang.RESMC20P04String2;
            }
            else
            {
                propertyGridEx_PC.Item[5].Value = CurLang.RESMC20P04String1;
            }
