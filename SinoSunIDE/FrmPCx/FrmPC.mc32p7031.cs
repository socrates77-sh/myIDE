...
namespace SinoSunIDE
{
    partial class FrmPC : DockContent
    {
        ...
        private void MC32P7031_OptionFill()
        {
            ...
            string[] FOSC = new string[] { CurLang.FOSC32P7011String000, CurLang.FOSC32P7011String010, CurLang.FOSC32P7011String100, CurLang.FOSC32P7011String101, CurLang.FOSC32P7011String110, CurLang.FOSC32P7011String111 };
...
//             propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(XTDRVB, true);
        ...
        private void MC32P7031_Value2Option(uint pValue, uint pValue0, uint pValue1, uint pValue2, uint pValue3, uint pValue4, uint pValue5)
        {
            int i = 0;
            uint temp = pValue0 & 7;
            if (temp == 4)
            {
                propertyGridEx_PC.Item[i].Value = "10x:2K";
            }
            else
            {
                propertyGridEx_PC.Item[i].Value = "01x:1K";
            }
...
//             if (temp == 0)
//             {
//                 propertyGridEx_PC.Item[2].Value = CurLang.FMODE32P7011String1;
//             }
//             else
//             {
//                 propertyGridEx_PC.Item[2].Value = CurLang.FMODE32P7011String2;
//             }
...
//             }
        ...
        private void MC32P7031_Option2Value()
        {
...
//             }
            ...
            if ( i== 0)
                propertyGridEx_PC.Item[5].Visible = true;
            else if(i == 2)
                propertyGridEx_PC.Item[5].Visible = true;
            else
                propertyGridEx_PC.Item[5].Visible = false;
