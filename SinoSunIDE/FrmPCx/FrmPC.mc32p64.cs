...
namespace SinoSunIDE
{
    partial class FrmPC : DockContent
    {
        ...
        private void MC32P64_OptionFill()
        {
            ...
            string[] LVRS = new string[] { CurLang.LVRSMC32P64String1, CurLang.LVRSMC32P64String2, CurLang.LVRSMC32P64String3, CurLang.LVRSMC32P64String4,
                                           CurLang.LVRSMC32P64String5, CurLang.LVRSMC32P64String6, CurLang.LVRSMC32P64String7, CurLang.LVRSMC32P64String8}; //0,1
            ...
            propertyGridEx_PC.Item.Add("LVRS", CurLang.LVRSMC32P64String1, false, CurLang.LVRSMC32P21Func, CurLang.LVRSMC32P21FuncExplain, true);
            ...
            propertyGridEx_PC.Item.Add("LOCK",0x0000, false, "Simple properties", "This is an hex type max=0xffff", true);
            //propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(PROTECT, true);

        }

        private void MC32P64_Value2Option(uint pvalue)
        {
            ...
            {
                case 0:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String1;
                    break;
                case 1:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String2;
                    break;
                case 2:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String3;
                    break;
                case 3:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String4;
                    break;
                case 4:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String5;
                    break;
                case 5:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String6;
                    break;
                case 6:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String7;
                    break;
                default:
                    propertyGridEx_PC.Item[5].Value = CurLang.LVRSMC32P64String8;
                    break;
            }
            ...
            temp=(pvalue>>16)& 0xffff;
            propertyGridEx_PC.Item[7].Value = temp;

        }
        private void MC32P64_Option2Value()
        {
            ...
            else if (temp == CurLang.WDTCString1)
            {
            ...
            //{ "000:LVR电压=3.0V", "001:LVR电压=2.8V", "010:LVR电压=2.6V", "011:LVR电压=2.8V", "100:LVR电压=2.4V",
            //                                "101:LVR电压=2.2V", "110:LVR电压=2.0V", "111:LVR电压=1.5V"}; //0,1
            if (temp == CurLang.LVRSMC32P64String1)
            {
                optValue_Temp = optValue_Temp | (0 << 10);
            }
            else if (temp == CurLang.LVRSMC32P64String2)
            {
                optValue_Temp = optValue_Temp | (1 << 10);
            }
            else if (temp == CurLang.LVRSMC32P64String3)
            {
                optValue_Temp = optValue_Temp | (2 << 10);
            }
            else if (temp == CurLang.LVRSMC32P64String4)
            {
                optValue_Temp = optValue_Temp | (3 << 10);
            }
            else if (temp == CurLang.LVRSMC32P64String5)
            {
                optValue_Temp = optValue_Temp | (4 << 10);
            }
            else if (temp == CurLang.LVRSMC32P64String6)
            {
                optValue_Temp = optValue_Temp | (5 << 10);
            }
            else if (temp == CurLang.LVRSMC32P64String7)
            {
            ...
            int aa = Convert.ToInt32(propertyGridEx_PC.Item[7].Value);
 
            optValue_Temp=optValue_Temp|(aa<<16);
