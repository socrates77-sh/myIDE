...
namespace SinoSunIDE
{
    partial class FrmPC : DockContent
    {
        ...
        private void MC10P02_OptionFill()
        {
           ...
           // propertyGridEx_PC.Item.Add("RES", "PB0上拉电阻无效", false, "PB0上拉电阻设置", "RES=False PB0上拉电阻无效；\nLVRE=True PB0上拉电阻有效", true);
           //ropertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(RES, true);
        ...
        private void MC10P02_Option2Value()
        {
            int optValue_Temp = 0;
        ...
        private void MC10P02_Value2Option(uint pValue)
        {
            uint temp = 0;
            ...
            //if (temp == 1)
            //{
            //    propertyGridEx_PC.Item[3].Value = "PB0上拉电阻有效";
            //}
            //else
            //{
            //    propertyGridEx_PC.Item[3].Value = "PB0上拉电阻无效";
            //}
