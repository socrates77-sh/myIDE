...
namespace SinoSunIDE
{
    partial class FrmPC : DockContent
    {
        ...
        private void MC32E22_OptionFill()
        {
            ...
            string[] MCLRE = new string[] { CurLang.MCLREMC32E22String0, CurLang.MCLREMC32E22String1 };
            ...
            string[] DENCR = new string[] { CurLang.ENCRMC32E22String0, CurLang.ENCRMC32E22String1 };
            string[] CENCR = new string[] { CurLang.ENCRMC32E22String0, CurLang.ENCRMC32E22String1 };
            string[] LPEN = new string[] { CurLang.LPENMC32E22String0, CurLang.LPENMC32E22String1 };
            string[] OPTWE = new string[] { CurLang.OPTWEMC32E22String00, CurLang.OPTWEMC32E22String01, CurLang.OPTWEMC32E22String10, CurLang.OPTWEMC32E22String11 };
            ...
            propertyGridEx_PC.Item.Add("MCLRE", CurLang.MCLREMC32E22String0, false, CurLang.MCLREPCFunc, CurLang.MCLREPCFuncExplain, true);
            ...
            propertyGridEx_PC.Item.Add("DENCR", CurLang.ENCRMC32E22String0, false, CurLang.DENCRMC32E22Func, CurLang.ENCRMC32E22FuncExplain, true);
            propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(DENCR, true);

            propertyGridEx_PC.Item.Add("CENCR", CurLang.ENCRMC32E22String0, false, CurLang.CENCRMC32E22Func, CurLang.ENCRMC32E22FuncExplain, true);
            propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(CENCR, true);

            propertyGridEx_PC.Item.Add("LPEN", CurLang.LPENMC32E22String0, false, CurLang.LPENMC32E22Func, CurLang.LPENMC32E22FuncExplain, true);
            propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(LPEN, true);

            propertyGridEx_PC.Item.Add("OPTWE", CurLang.OPTWEMC32E22String00, false, CurLang.OPTWEMC32E22Func, CurLang.OPTWEMC32E22FuncExplain, true);
            propertyGridEx_PC.Item[propertyGridEx_PC.Item.Count - 1].Choices = new CustomChoices(OPTWE, true);
        }


        private void MC32E22_Option2Value()
        {
            int optValue_Temp,optValue_Temp0;
            optValue_Temp = optValue_Temp0 = 0;
            //WDTC
            ...
            if (temp == CurLang.MCLREMC32E22String0)
            ...
            if (temp == CurLang.LPENMC32E22String0)
            {
            ...
            if (temp == CurLang.OPTWEMC32E22String00)
            {
                optValue_Temp0 = optValue_Temp0 | (0 << 14);
            }
            else if (temp == CurLang.OPTWEMC32E22String01)
            {
                optValue_Temp0 = optValue_Temp0 | (1 << 14);
            }
            else if (temp == CurLang.OPTWEMC32E22String10)
            {
                optValue_Temp0 = optValue_Temp0 | (2 << 14);
            }
            else
            {
                optValue_Temp0 = optValue_Temp0 | (3 << 14);
            }

            optionValue.Text = Convert.ToString(optValue_Temp, 16);
            optionValue1.Text = Convert.ToString(optValue_Temp0, 16);

        }

        private void MC32E22_Value2Option(uint pValue)
        {
            uint temp = 0;
            ...
            temp = (pValue >> 7) & 1;
            if (temp == 0)
                propertyGridEx_PC.Item[3].Value = CurLang.MCLREMC32E22String0;
            else
                propertyGridEx_PC.Item[3].Value = CurLang.MCLREMC32E22String1;
            ...
            if (temp == 0)
            {
                propertyGridEx_PC.Item[7].Value = CurLang.ENCRMC32E22String0;
            }
            else
            {
                propertyGridEx_PC.Item[7].Value = CurLang.ENCRMC32E22String1;
            }
...
//             if (temp == 0)
//             {
//                 propertyGridEx_PC.Item[8].Value = CurLang.LPENMC32E22String0;
//             }
//             else
//             {
//                 propertyGridEx_PC.Item[8].Value = CurLang.LPENMC32E22String1;
//             }
...
//             {
//                 case 0:
//                     propertyGridEx_PC.Item[9].Value = CurLang.OPTWEMC32E22String00;
//                     break;
//                 case 1:
//                     propertyGridEx_PC.Item[9].Value = CurLang.OPTWEMC32E22String01;
//                     break;
//                 case 2:
//                     propertyGridEx_PC.Item[9].Value = CurLang.OPTWEMC32E22String10;
//                     break;
//                 default:
//                     propertyGridEx_PC.Item[9].Value = CurLang.OPTWEMC32E22String11;
//                     break;
//             }
        }
    }
